...
export const about_me =
  "<p>I am <b>Mukadus Jawaid</b>, a graduate from <b>Sir Syed University</b>, Department of <b>Software Engineering</b>, having completed my degree in <b>April 2024</b>. This website is a project I built for <i>personal practice</i> and as a showcase of cars. The website is designed to provide informative content about cars, such as specifications, features, and performance. All of the data is static for now, and the images used were sourced from <a href='https://unsplash.com' target='_blank'><u>Unsplash</u></a> and <a href='https://www.pexels.com' target='_blank'><u>Pexels</u></a>. These images were cropped, edited, and adjusted to fit the website’s design. Additionally, I have written the content with the help of <i><u>ChatGPT</u></i>, as I wanted to incorporate AI-generated content to improve the website's readability and engagement.</p><br />" +
  "<p>This project is not intended for commercial use, and I don’t have any consent or ownership of the images and data provided. It was created purely for <b><i>personal learning</i></b> and development purposes. Regarding the design, this is <span style='color: #3498db;'><b>entirely my work</b></span>. I have spent a lot of time thinking and creating something <i><b> aesthetically pleasing</b></i> from scratch, without using any pre-designed templates or tools like Figma. The website’s design is inspired by my vision of building something unique, and I have worked on the layout and user interface <u><b>myself</b></u>, and also made it responsive to ensure it works seamlessly across different devices.</p><br />" +
  "<p>This website is designed as a showcase of cars, providing users with knowledgeable information about different car models. The purpose of the site is to educate car enthusiasts about the latest car trends and innovations, offering detailed descriptions and specifications for each featured car. Currently, the data is static, meaning that the content remains the same for now, but it serves as an excellent example of what can be done with <b><i>React</i></b> and static data. The design of the website is simple and clean, with a focus on visual aesthetics and readability.</p><br />" +
