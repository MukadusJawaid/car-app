...
export const FirstButton = (props) => {
  ...
  return (
    <button
      className="embla__button embla__button--first"
      type="button"
      {...restProps}
    >
      <svg className="embla__button__svg" viewBox="0 0 512 512">
        <path
          fill="currentColor"
          d="M352 76.8c0-25.6-30.7-38.4-48.3-20.3L96 256l207.7 199.5c17.6 18.1 48.3 5.3 48.3-20.3V76.8z"
        />
      </svg>
      {children}
    </button>
